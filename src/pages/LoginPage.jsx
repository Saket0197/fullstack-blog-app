...
export default function LoginPage() {
  ...
  return (
    <div className='md:mt-28 flex flex-col gap-9 items-center mt-7 rounded-lg py-7'>
      ...
      <form onSubmit={handleSubmit(handleLogin)} className='flex flex-col w-full gap-4 p-4 text-lg'>
          ...
          <button className='md:w-[40%] capitalize rounded-lg font-bold bg-[#2ed853c7] border border-[#2ed853] hover:bg-[#2ed85377] p-2 w-[20%] mx-auto transition duration-200 text-[#fff]'>Login</button>
      </form>
    </div>
  )
}
